...
public class StaffQuartersDao {
	...
	public void updateStaffQuartersObjectData(JSONObject jsonObject,String tableName,String tableColumn) { 
		try {
			String STAFF_QUARTERS_OBJECT_MERGE_SQL = "INSERT INTO #TABLE_NAME# (Staff_Quarter_Id, #TABLE_COLUMN#, Block_Id, Floor_Id,Length,Width, Plinth_Area, "+
						...
						" VALUES (:staffQuarterId,:buildingId,:buildingId,:buildingId,:length,:width,:carpetAreaCnt,"+
