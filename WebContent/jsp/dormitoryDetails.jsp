  ...
  if (a == "") {
    ...
    for (var i = 0; i < a; i++) {
    	 rows += "<div class='panel-group dormitoryHallDiv'> <div class='panel panel-default' ><div class='panel-heading'><h4 class='panel-title'><a data-toggle='collapse' data-parent='#accordion' href='#collapse1222".concat(i+1)+ "'><span class='glyphicon glyphicon-menu-down'></span></a>&nbsp;&nbsp;&nbsp;<a href='#' >	Hall</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='checkbox' dbname='hall'/></h4> </div> "+
		         ...
		         "<table class='table'> <tr><td> <label><b>Block</b></label><br/> <select name='H_Block_Id_#I#' id='H_Block_Id_#I#' dbname='blockId' class='form-control' style='width:200px;'>     <option value='0'>Select block</option> <option value='1'>1st Block</option> <option value='2'>Second Block</option> <option value='3'>Third Block</option> </select> </td>  <td> <label><b>Floor</b></label><br/> <select dbname='floorId' name='H_Floor_Id_#I#' id='H_Floor_Id_#I#' class='form-control' style='width:200px;'>     <option value='0'>Select floor</option> <option value='1'>Ground Floor</option> <option value='2'>First Floor</option> <option value='3'>Second Floor</option> </select> </td></tr>"+  
		         "<tr><td><a href='#'>Length (in sft)</a><br><input type='text' name='H_Length_#I#' id='H_Length_#I#' dbname='length' /></td><td><a href='#'>Width (in sft)</a><br><input type='text' name='H_Width_#I#' id='H_Width_#I#' dbname='width' /></td></tr><tr> <td><a href='#'>Carpet Area</a> <input type='checkbox'><br> <input type='text' name='H_Plinth_Area_#I#' id ='H_Plinth_Area_#I#' dbname='carpetAreaCnt' readonly=true></td><td><a href='#'>Ceiling Fans</a> <input type='checkbox' name='H_Ceiling_Fans_#I#' id ='H_Ceiling_Fans_#I#' dbname='ceilingFans'><br> <input type='text' name='H_Ceiling_Fans_Count_#I#' id ='H_Ceiling_Fans_Count_#I#' dbname='ceilingFansCnt'></td> 	</tr>  "+
		         ...
		         "<tr><td><a href='#'>Windows</a> <input type='checkbox' name='H_Windows_#I#' id ='H_Windows_#I#' dbname='windows'><br> <input type='text' name='H_Windows_Count_#I#' id ='H_Windows_Count_#I#' dbname='windowsCnt'></td><td><a href='#'>Window Mosquito mesh</a><br> <input type='text' name='H_Window_Mosquito_Mesh_Count_#I#' id ='H_Window_Mosquito_Mesh_Count_#I#' dbname='windowMeshCnt'></td></tr> "+
		         "<tr><td><a href='#'>Ventilators</a><br> <input type='text' name='H_Ventilators_Count_#I#' id ='H_Ventilators_Count_#I#' dbname='ventilatorsCnt'></td><td><a href='#'>Ventilator Mosquito mesh</a><br> <input type='text' name='H_Ventilator_Mosquito_Mesh_Count_#I#' id ='H_Ventilator_Mosquito_Mesh_Count_#I#' dbname='ventilatorMeshCnt'></td></tr>"+
		         "<tr><td><a href='#'>Doors</a> <input type='checkbox' name='H_Doors_#I#' id ='H_Doors_#I#' dbname='doors'><br> <input type='text' name='H_Doors_Count_#I#' id ='H_Doors_Count_#I#' dbname='doorsCnt'></td><td><a href='#'>2+1 tier Cots</a> <input type='checkbox' name='H_two_one_tier_cots_#I#' id ='H_two_one_tier_cots_#I#' dbname='2OneTierCots'><br> <input type='text' name='H_two_one_tier_cots_Count_#I#' id ='H_two_one_tier_cots_Count_#I#' dbname='2OneTierCotsCnt'></td></tr>"+  
		         ...
		         "<tr><td><a href='#'>Glass Door Almira</a> <input type='checkbox' name='H_Glass_Door_Almira_#I#' id ='H_Glass_Door_Almira_#I#' dbname='glassDoorAlmira'><br> <input type='text' name='H_Glass_Door_Almira_Count_#I#' id ='H_Glass_Door_Almira_Count_#I#' dbname='glassDoorAlmiraCnt'></td><td><a href='#'>Wooden Almira</a> <input type='checkbox' name='H_Wooden_Almira_#I#' id ='H_Wooden_Almira_#I#' dbname='woodenAlmira'><br> <input type='text' name='H_Wooden_Almira_Count_#I#' id ='H_Wooden_Almira_Count_#I#' dbname='woodenAlmiraCnt'></td></tr>"+  
		         "<tr><td><a href='#'>Storewell Almira</a> <input type='checkbox' name='H_Store_Well_Almira_#I#' id ='H_Store_Well_Almira_#I#' dbname='storeWallAlmira'><br> <input type='text' name='H_Store_Well_Almira_Count_#I#' id ='H_Store_Well_Almira_Count_#I#' dbname='storeWallAlmiraCnt'></td></tr>"+  
