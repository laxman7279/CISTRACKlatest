							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table">
										...
										<tr>
											<td style="margin-bottom: 20px;"><a href="#"> Wind Power Supply</a>
											<input type="checkbox" id="HasWiPowSupp" name="HasWiPowSupp" class="dontHideCls" /></td>
											<td style="margin-bottom: 20px;"><a href="#">Capacity</a>
											<input type="text" id="WiPowCapacity" name="WiPowCapacity" /></td>
										</tr>
										<tr>
											<td style="margin-bottom: 20px;"><a href="#"> Solar Power Supply</a>
											<input type="checkbox" id="HasSoPowSupp" name="HasSoPowSupp" class="dontHideCls" /></td>
											<td style="margin-bottom: 20px;"><a href="#">Capacity</a>
											<input type="text" id="SoPowCapacity" name="SoPowCapacity" /></td>
										</tr>
										<tr>
											<td style="margin-bottom: 20px;"><a href="#">Electrical Power Supply</a>
											<input type="checkbox" id="HasElPowSupp" name="HasElPowSupp" class="dontHideCls" /></td>
											<td style="margin-bottom: 20px;"><a href="#">Capacity</a>
											<input type="text" id="ElPowCapacity" name="ElPowCapacity" /></td>
										</tr>
										<tr>
											<td style="margin-bottom: 20px;"><a href="#"> Generator Power Supply</a>
											<input type="checkbox" id="HasGePowSupp" name="HasGePowSupp" class="dontHideCls" /></td>
											<td style="margin-bottom: 20px;"><a href="#">Capacity</a>
											<input type="text" id="GePowCapacity" name="GePowCapacity" /></td>
										</tr>
										<tr>
											<td style="margin-bottom: 20px;"><a href="#"> Electrical Transformer</a>
											<input type="checkbox" id="ELTransformer" name="ELTransformer" class="dontHideCls" /></td>
											<td style="margin-bottom: 20px;"><a href="#">Capacity</a>
											<input type="text" id="ElTaCapacity" name="ElTaCapacity" /></td>
										</tr>
									</table>
								</div>
							</div>
							...
							<table class="table">
								...
								<tr>
									<td style="margin-bottom: 20px;"><a href="#">Street
										...
										id="HasStreetLigY" value="Y"> <b style="color: black">Yes</b>&nbsp;&nbsp;
										<input type="radio" name="HasStreetLig" id="HasStreetLigN"
										value="N"> <b style="color: black">No</b></td>
...
function populateOtherDetails(){
	...
	getGuardRoomDetails();
	getPowSuppDetails();
	getInternalRoadsDetails();
	getExtWaterSupDetails();
