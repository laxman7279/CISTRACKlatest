...
<script type="application/x-javascript">
	...
	function switchClass() {
		...
		if ($('#switchWaiting').hasClass('active')) {
	...
	function switchWaitingHall() {
		...
		//alert(document.getElementById('Dorm-Div').style.display);
		if (document.getElementById('EPWH-Div').style.display == 'none')
			document.getElementById('EPWH-Div').style.display = 'block';
		else
			document.getElementById('EPWH-Div').style.display = 'none';
	...
	function addClassRooms() {
		...
		if (a == "") {
			...
			var rows = "";
			for (var i = 0; i < a; i++) {
				rows += " <div class='panel-group' id='accordion'> <div class='panel panel-default'> <div class='panel-heading'> <h4 class='panel-title'> <a data-toggle='collapse' data-parent='#accordion'  	href='#collapse1200"+i+ "'> <span class='glyphicon glyphicon-menu-down'></span></a>&nbsp;&nbsp;Class Room&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </h4> </div><div id='collapse1200"+i+"' class='panel-collapse collapse'><div class='panel-body'> <div class='table-responsive'><table class='table'> <tr><td><a href='#'>Floor</a><br/><select  name ='CR_floor_"+i+"'   id ='CR_floor_"+i+"'   dbname='floor' class='form-control'> <option value='Select Floor'>Select Floor</option> <option value='Ground Floor'>Ground Floor</option> <option value='First Floor'>First Floor</option> <option value='Second Floor'>Second Floor</option> </select> </td><td><a href='#'>Class Name</a><br/><input type='text' name='CR_ClassNameck_"+i+"' id='CR_ClassNameck_"+i+"' dbname='className' /></td> </tr>"+
				"<tr> <td><a href='#'>Table Fans</a> <input type='checkbox' name ='CR_TableFans_"+i+"'   id ='CR_TableFans_"+i+"' dbname='tableFans'><br> <input type='text' name ='CR_TableFansCount_"+i+"'   id ='CR_TableFansCount_"+i+"' dbname='tableFansCount' ></td> <td><a href='#'>Reading Tables</a> <input type='checkbox' dbname='readingTables' name ='CR_ReadingTables_"+i+"'   id ='CR_ReadingTables_"+i+"'><br><input type='text' dbname='readingTablesCount' name ='CR_ReadingTablesCount_"+i+"'   id ='CR_ReadingTablesCount_"+i+"'></td> </tr> <tr> <td><a href='#'>Ceiling Fans</a> <input type='checkbox' dbname='ceilingFans' name ='CR_CeilingFans_"+i+"'   id ='CR_CeilingFans_"+i+"'><br> <input type='text' dbname='ceilingFansCount' name ='CR_CeilingFansCount_"+i+"'   id ='CR_CeilingFansCount_"+i+"'></td> <td><a href='#'>Tables</a> <input type='checkbox' dbname='tables' name ='CR_Tables_"+i+"'   id ='CR_Tables_"+i+"'><br> <input type='text' dbname='tablesCount' name ='CR_TablesCount_"+i+"'   id ='CR_TablesCount_"+i+"'></td> </tr>"+
				"<tr> <td><a href='#'>Chairs</a> <input type='checkbox' dbname='chairs' name ='CR_Chairs_"+i+"'   id ='CR_Chairs_"+i+"'><br> <input type='text' dbname='chairsCount' name ='CR_ChairsCount_"+i+"'   id ='CR_ChairsCount_"+i+"'></td> <td><a href='#'>Tube Lights</a> <input dbname='tubeLights' type='checkbox' name ='CR_TubeLights_"+i+"'   id ='CR_TubeLights_"+i+"'><br> <input type='text' dbname='tubeLightsCount' name ='CR_TubeLightsCount_"+i+"'   id ='CR_TubeLightsCount_"+i+"'></td> </tr> <tr> <td><a href='#'>Bulbs</a> <input dbname='bulbs'  type='checkbox' name ='CR_Bulbs_"+i+"'   id ='CR_Bulbs_"+i+"'><br> <input type='text' dbname='bulbsCount' name ='CR_BulbsCount_"+i+"'   id ='CR_BulbsCount_"+i+"' ></td> <td><a href='#'>Locker Units</a> <input type='checkbox' dbname='lockerUnits' name ='CR_LockerUnits_"+i+"'   id ='CR_LockerUnits_"+i+"'><br> <input type='text' dbname='lockerUnitsCount' name ='CR_LockerUnitsCount_"+i+"'   id ='CR_LockerUnitsCount_"+i+"'></td> </tr>"+
				"<tr> <td><a href='#'>Stools</a> <input type='checkbox' name ='CR_Stools_"+i+"'  dbname='stools' id ='CR_Stools_"+i+"'><br> <input type='text' dbname='stoolsCount' name ='CR_StoolsCount_"+i+"'   id ='CR_StoolsCount_"+i+"'></td> <td><a href='#'>S Type chairs</a> <input type='checkbox' dbname='sTypeChairs' name ='CR_STypeChairs_"+i+"'   id ='CR_STypeChairs_"+i+"'><br> <input type='text' dbname='sTypeChairsCount' name ='CR_STypeChairsCount_"+i+"'   id ='CR_STypeChairsCount_"+i+"'></td> </tr> <tr> <td><a href='#'>Wooden Almira</a><br><input type='text' name='CR_Wooden_Almira_"+i+"' id='CR_Wooden_Almira_"+i+"' dbname='woodenAlmiraCount' /></td><td><a href='#'>Dual Desks</a> <input type='checkbox' dbname='dualDesk' name ='CR_DualDesks_"+i+"'   id ='CR_DualDesks_"+i+"'><br> <input type='text' dbname='dualDeskCount' name ='CR_DualDesksCount_"+i+"'   id ='CR_DualDesksCount_"+i+"'></td> <td></td> </tr> "+
				"<tr> <td><a href='#'>Glass Door Almira</a> <input type='checkbox' dbname='glassDoorAlmira' name ='CR_GDAlmira_"+i+"'   id ='CR_GDAlmira_"+i+"'><br> <input type='text' dbname='glassDoorAlmiraCount' name ='CR_GDAlmiraCount_"+i+"'   id ='CR_GDAlmiraCount_"+i+"'></td><td><a href='#'>Store well Almira</a> <input type='checkbox' dbname='storeWellAlmira' name ='CR_SWA_"+i+"'   id ='CR_SWA_"+i+"'><br> <input type='text' dbname='storeWellAlmiraCount' name ='CR_SWACount_"+i+"'   id ='CR_SWACount_"+i+"'></td></tr> <tr> <td><a href='#'>Green Boards</a> <input type='checkbox' dbname='greenBoards' name ='CR_GrBd_"+i+"'   id ='CR_GrBd_"+i+"'><br> <input type='text' dbname='greenBoardsCount' name ='CR_GrBdCount_"+i+"'   id ='CR_GrBdCount_"+i+"'></td><td><a href='#'>Black Boards</a> <input type='checkbox' dbname='blackBoards' name ='CR_BkBd_"+i+"'   id ='CR_BkBd_"+i+"'><br> <input type='text' dbname='blackBoardCount' name ='CR_BkBdCount_"+i+"'   id ='CR_GrBkCount_"+i+"'></td></tr>"+
				"<tr><td hidden='true'><a href='#'>Carpet Area (in sft)</a> <input type='checkbox' dbname='carpetArea' ><br> <input type='text' dbname='carperAreaCount' name ='CR_Plinth_"+i+"'   id ='CR_Plinth_"+i+"' hidden='true'></td> </tr> </table> </div> </div> </div> </div> </div>";
			}
...
function bindChangeEvent(){
	$('input[name*="Length"],input[name*="Width"]').off('change').on('change',function(){
		var keyId = $(this).attr('id');
		var lengthId = keyId.replace(/Width/g, 'Length');
		var widthId = keyId.replace(/Length/g, 'Width');
		var length = isNaN($('#'+lengthId).val()) ? 0 : $('#'+lengthId).val();
		var width = isNaN($('#'+widthId).val()) ? 0 : $('#'+widthId).val();
		$('#'+lengthId.replace(/Length/g,'Plinth')).val($.trim(length)*$.trim(width));
		$('#'+lengthId.replace(/Length/g,'Plinth_Area')).val($.trim(length)*$.trim(width));
		$('#'+lengthId.replace(/Length/g,'PlintArea')).val($.trim(length)*$.trim(width));
	});
}
...
<body>
 ...
 <div id="EPWH-Div" style="background-color: #b3c2ff; padding-bottom: 40px; padding-left: 70px; padding-right: 40px; padding-top: 40px; margin: 10px; display: none;">
		<jsp:include page="epwaitinghall.jsp" /> 
	</div>
	<!--others-->
