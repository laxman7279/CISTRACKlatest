		...
		<div class="container">
			<div class="agile_header_grid">
				<div class="w3_agile_logo" style="float: left;">
					<h1><a href="/jsp/index.jsp"><span>CIS</span>Tracker</a></h1>
				</div>
				...
				<div class="agileits_w3layouts_sign_in">
					...
					<li><img alt="" src="./../images/logo.png"></li>
						...
						%>
						<li><a href="#small-dialog" class="play-icon popup-with-zoom-anim "  onclick="doLogOut()"><%out.print( request.getSession().getAttribute("User")) ;%></a></li>
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="/jsp/index.jsp" class="hvr-sweep-to-bottom">Requests</a></li>
								<!-- <li class="dropdown">
								...
								<li><a href="../CIS/assetmanagment.htm" class="hvr-sweep-to-bottom">Asset Management</a></li>
								<li><a href="/jsp/portfolio.jsp" class="hvr-sweep-to-bottom">Progress Reports</a></li>
								<li><a href="/jsp/index.jsp" class="hvr-sweep-to-bottom">Dashboard</a></li>
							</ul>
...
<!-- pop-up-box -->
	<div id="small-dialog" class="mfp-hide w3ls_small_dialog wthree_pop">
		...
		<div class="agileits_signin_form">
			<form action="./userRegistration.htm" method="post">
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					<h2><a href="/jsp/index.jsp"><span>M</span>ission</a></h2>
	...
	<div class="copyright">
		<div class="container">
			<div class="w3ls_copyright_left">
				<ul>
					<li class="active"><a href="/jsp/index.jsp">Home</a></li>
					<li><a href="/jsp/index.jsp">Requests</a></li>
					<li><a href="../CIS/assetmanagment.htm">Asset Management</a></li>
					<li ><a href="/jsp/portfolio.jsp">Progress Reports</a></li>
					<li ><a href="/jsp/index.jsp">Dashborad</a></li>
