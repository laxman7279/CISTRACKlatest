...
<!-- services -->
    ...
    <label>Sanitary System</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
  ...
  <!--Compound Wall  -->
   ...
   <div style="background-color: #dfff80;padding-bottom: 40px;padding-left: 40px;padding-right: 40px;padding-top: 40px; float: left; margin: 10px;">
    ...
    <label>Compound Wall</label> <img alt="" src="images/wrong.png" style="padding-left: 15px;">
    ...
    <label>Gaurd Room</label> <img alt="" src="images/wrong.png" style="padding-left: 15px;">
...
<div style="background-color: #ffcc99;padding-bottom: 40px;padding-left: 40px;padding-right: 40px;padding-top: 40px; float: left; margin: 10px;">
    ...
    <label>Power Generator</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
...
<div style="background-color: #d699ff;padding-bottom: 40px;padding-left: 40px;padding-right: 40px;padding-top: 40px; float: left; margin: 10px;">
    ...
    <label>Internal Roads</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
...
<div style="background-color: #ff99e6;padding-bottom: 40px;padding-left: 40px;padding-right: 40px;padding-top: 40px; float: left; margin: 10px;">
    ...
    <label>Street Lighting</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
...
<!--Under Ground Pump  -->
    ...
    <label>Under Ground Pump</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
    ...
    <label>External Water Supply</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
...
<!-- OverHead Service Reservoir -->
    ...
    <label>OverHead Service Reservoir</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
...
<script type="text/javascript">
	...
	<label>School Building</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
    ...
    <li style="padding-bottom: 40px;"><span class="Collapsable" style="font-size: large; padding-bottom: 20px;"></span> <ul>
        ...
        <li></li>
        <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">GF- Labs </span><img alt="" src="images/tick.png" style="padding-left: 15px;"><ul>
            <li style="font-size:small; padding-left: 18px;"><span class="Collapsable">Physics</span><img alt="" src="images/tick.png" style="padding-left: 15px;"></li>
            <li style="font-size:small; padding-left: 18px;"><span class="Collapsable">Chemistry</span><img alt="" src="images/tick.png" style="padding-left: 15px;"></li>
            <li style="font-size:small; padding-left: 18px;"><span class="Collapsable">Botany</span><img alt="" src="images/tick.png" style="padding-left: 15px;"></li>
            <li style="font-size:small; padding-left: 18px;"><span class="Collapsable">Zoology</span><img alt="" src="images/wrong.png" style="padding-left: 15px;"></li>
        </ul>
        </li>
        <li></li>
        <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Library Room</span><img alt="" src="images/wrong.png" style="padding-left: 15px;"></li>
        <li></li>
        <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Computer Room</span><img alt="" src="images/tick.png" style="padding-left: 15px;">
        ...
        <li></li>
          <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Office Store</span><img alt="" src="images/tick.png" style="padding-left: 15px;"> </li>
      <li></li>
        <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Staff Room</span><img alt="" src="images/tick.png" style="padding-left: 15px;"> </li>
      
      <li></li>
        <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Principal Room</span><img alt="" src="images/tick.png" style="padding-left: 15px;"> </li>
      <li></li>
        <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Games Room</span><img alt="" src="images/wrong.png" style="padding-left: 15px;"> </li>
      <li></li>
        
        <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Entrance Hall</span><img alt="" src="images/tick.png" style="padding-left: 15px;"> </li>
      
        <li></li>
        <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Toilet Blocks</span><img alt="" src="images/tick.png" style="padding-left: 15px;"> 
      ...
      <li></li>
      <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">FF Class Rooms</span><img alt="" src="images/tick.png" style="padding-left: 15px;"> 
      ...
      <li></li>
      <li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">SF Class Rooms</span><img alt="" src="images/tick.png" style="padding-left: 15px;"> 
	...
	<label>Dormitory Building</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
...
<li style="font-size:medium; padding-left: 15px;" ><span class="Collapsable">Office Room </span><img alt="" src="images/wrong.png" style="font-size:medium; padding-left: 15px;"></li>
  ...
  <li></li>
	...
	<label>Principal Quarters</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
	...
	<label>Staff Quarters</label> <img alt="" src="images/tick.png" style="padding-left: 15px;">
